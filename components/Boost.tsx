        ...
        <div className="flex-grow mt-4 bg-[#f3ba2f] rounded-t-[48px] relative top-glow z-0">
          <div className="mt-[2px] bg-[#1d2025] rounded-t-[46px] h-full overflow-y-auto no-scrollbar">
            <div className="px-4 pt-1 pb-24">
              ...
              <h2 className="text-base mt-8">Бесплатные ежедневные бустеры</h2>
              <div className="mt-4">
                <button
                ...
                >
                  <div className="flex items-center">
                    ...
                    <div className="flex flex-col ml-2">
                      ...
                      <span className="font-normal text-gray-500">{energyRefillsLeft}/6 доступно</span>
                    </div>
                  </div>
                  {isLoadingRefill ? (
                    ...
                    <span className="text-[#f3ba2f]">Пополнить</span>
                  )}
                </button>
              </div>

              <h2 className="text-base mt-8">Улучшения</h2>
              <div className="mt-4">
                <button className="w-full flex justify-between items-center bg-[#272a2f] rounded-lg p-4" onClick={handleMultitapUpgrade}
                  ...
                  {isLoadingMultitap ? (
                    ...
                    <span className="text-[#f3ba2f]">Прокачать</span>
                  )}
                </button>
